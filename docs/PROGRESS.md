...
- iOS device development build with post success and capture exits finished: `3aaf5ed4-f61e-4a56-9e42-0ab030b73ed7`.
- iOS device install URL ready: `https://expo.dev/accounts/ryoaxelrod/projects/dayby/builds/3aaf5ed4-f61e-4a56-9e42-0ab030b73ed7`
- iOS device development build with daily story navigation refinements finished: `4948620a-f07f-4160-97ea-1533ee7e6126`.
...
- iOS device development build with first UI polish pass finished: `f71f5624-8213-49ab-a661-04e8f8c0e2ab`.
- iOS device install URL ready: `https://expo.dev/accounts/ryoaxelrod/projects/dayby/builds/f71f5624-8213-49ab-a661-04e8f8c0e2ab`
- iOS device development build with consistent Home logout access finished: `b4928821-9e4d-4863-bddd-5528c929460b`.
- iOS device install URL ready: `https://expo.dev/accounts/ryoaxelrod/projects/dayby/builds/b4928821-9e4d-4863-bddd-5528c929460b`
- iOS device development build with full-screen signed-out Home demo finished: `7dd01c4d-e301-4c66-9be0-2bb2522f831a`.
- iOS device install URL ready: `https://expo.dev/accounts/ryoaxelrod/projects/dayby/builds/7dd01c4d-e301-4c66-9be0-2bb2522f831a`
- iOS device development build with fixed signed-out full-screen layout finished: `43acb231-f791-46a6-9fb0-44f761fd7d85`.
- iOS device install URL ready: `https://expo.dev/accounts/ryoaxelrod/projects/dayby/builds/43acb231-f791-46a6-9fb0-44f761fd7d85`
